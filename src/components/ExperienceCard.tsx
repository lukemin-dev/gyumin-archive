...
export default function ExperienceCard({ experience }: ExperienceCardProps) {
  ...
  return (
    <article className="border-t-2 border-stone-800 py-6 sm:py-7">
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        ...
        <div className="border-l-2 border-emerald-700 pl-4">
          <p className="text-xs font-bold text-emerald-800">결과</p>
      ...
      <details className="group mt-5 border-t border-slate-100 pt-4">
        <summary className="cursor-pointer list-none text-sm font-semibold text-emerald-800 marker:hidden">
          <span className="group-open:hidden">문제 해결 과정 펼쳐보기 ↓</span>
          <span className="hidden group-open:inline">문제 해결 과정 접기 ↑</span>
        </summary>
        <div className="mt-4 grid gap-5 border-l border-stone-300 pl-5 md:grid-cols-3">
