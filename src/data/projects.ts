...
export const projects: Project[] = [
  {
    ...
    interviewPoints: [
      "429 Quota Exceeded가 났을 때 어떻게 처리했나요?",
      "3일에서 10초로 줄었다는 기준은 무엇인가요?",
      "같은 입력에서 같은 결과가 나오게 하기 위해 어떤 검증을 했나요?",
    ],
    ...
    shortQuestion: "Gemini Quota Exceeded 문제를 어떻게 처리했나요?",
    privateCode: true,
    featured: true,
  },
  {
    ...
    interviewPoints: [
      "메시지가 나뉘어 들어오면 왜 데이터가 깨졌나요?",
      "수신 버퍼를 어떤 기준으로 처리했나요?",
      "팀원이 같은 문제를 같은 기준으로 볼 수 있게 한 방법은 무엇인가요?",
    ],
    ...
    shortQuestion: "수신 버퍼를 어떤 기준으로 처리했나요?",
  ...
  },
  {
    ...
    shortQuestion: "네트워크 불안정 시 센서 데이터를 어떻게 보존했나요?",
  ...
  },
  {
    ...
    interviewPoints: [
      "LIKE 쿼리로 인한 성능 저하를 정확히 어떻게 측정하고 개선했나요?",
      "계층형 카테고리를 관계형 데이터베이스에서 어떻게 모델링했나요?",
    ...
    shortQuestion: "LIKE 쿼리로 인한 성능 저하를 정확히 어떻게 측정하고 개선했나요?",
