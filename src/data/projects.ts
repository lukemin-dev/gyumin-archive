...
export const projects: Project[] = [
  {
    ...
    details: [
      ...
      "이후 실제 컨베이어 운영에서 양파 8,092개의 플래시 작동과 데이터 기록을 전량 확인",
    ],
    role: "팀 프로젝트 · AI 모델 학습·튜닝, 데이터 라벨링·품질 확인, 센서·PLC 신호 흐름 분석과 현장 검증",
    ...
    myContribution: [
      ...
      "센서 설정 변경 후 플래시 작동과 데이터 기록을 기준으로 실제 운영 결과 재검증",
    ],
    bottleneck:
    ...
    validation: [
      "초기 검증 100개 중 플래시 작동과 데이터 기록이 완료된 80개를 성공으로 집계",
      "센서 설정 변경 후 양파 8,092개가 통과한 실제 운영 구간에서 같은 기준으로 전량 성공 확인",
    ...
    shortResult: "초기 100개 중 80개였던 촬영 성공을 개선해 실제 운영에서 양파 8,092개의 플래시 작동과 데이터 기록을 전량 확인했습니다.",
    shortQuestion: "현장 AI 시스템에서 모델과 설비 문제를 분리해 추적한 방법",
    privateCode: true,
    evidence: [
      {
        label: "현장 검증 결과",
        description: "센서 설정 변경 후 실제 컨베이어 운영에서 양파 8,092개 모두 플래시가 작동하고 데이터가 기록되는 것을 확인했습니다.",
      },
      {
        label: "데이터 활용",
